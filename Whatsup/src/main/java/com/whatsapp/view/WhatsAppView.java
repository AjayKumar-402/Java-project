	...
	public static void main(String[] args) {
		...
		while (ss.equals("y")) {
			...
			case 1:
				...
				break;
			case 2:
				int c1 =wc.createProfile();
				if(c1>0) {
					System.out.println("view profile succesfully");
				}
				else {
					System.out.println("couldnt find the view profile");
				}
				break;
			case 3:
				break;
			...
			case 5:
				break;
			case 6:
				int c11 = wc.viewAllProfile();
				if (c11 > 0) {
					System.out.println(c11+" record found");
				} else {
